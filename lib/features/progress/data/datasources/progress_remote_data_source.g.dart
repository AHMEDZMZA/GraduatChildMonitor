...
part of 'progress_remote_data_source.dart';
...
class _ProgressRemoteDataSource implements ProgressRemoteDataSource {
  ...
  Future<ProgressSummaryModel> getProgressSummary() async {
    ...
    late ProgressSummaryModel _value;
    try {
      _value = ProgressSummaryModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<TrendModel> getTrend(String childId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TrendModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TrendModel _value;
    try {
      _value = TrendModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<ActivityStatsModel> getActivityStats(String childId) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ActivityStatsModel _value;
    try {
      _value = ActivityStatsModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
